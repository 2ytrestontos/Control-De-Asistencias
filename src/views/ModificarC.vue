<template>
  <div v-if="$store.state.sesion && $store.state.tipo == 'Profesor'">
    <!-- modal alumnos curso -->
    <div class="modal fade" id="Alumnos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
            ...
            <div v-if="cant > 0">
              <table class="table">
                ...
                <tbody v-if="$store.state.tutoria == $route.params.nombre">
                  <tr v-for="alumnos in alumnos" class="linea" :key="alumnos._id">
                    <td>
                    ...
                    <td>
                      <i class="fas fa-trash-alt" v-on:click="borrarAlumno(alumnos._id)"></i>
                    </td>
                  </tr>
                </tbody>
                <tbody v-else>
    ...
    <div class="row col">
      <i class="fas fa-arrow-left col-1 mt-2 p-0" style="font-size: 1.5rem" v-on:click="back()"></i>
      <h2 class="col mt-2 p-0">
        Modificar Datos del Curso: {{ input.grado }} / {{ input.nombre }}
      </h2>
      <h5 class="col-1 mt-2 p-0">
        Alumnos:
        <b style="color: #36bcdf; cursor: pointer" data-toggle="modal" data-target="#Alumnos">{{ cant }}</b>
      </h5>
    </div>
    ...
    <div class="form-row col">
      <div class="col-6">
        ...
        <input type="date" class="form-control col" v-model="input.fechainicio" />
      </div>
      <div class="col-6">
      ...
      <div class="col">
        ...
        <select name="Tutoria" id="Tutoria" class="form-control col" v-model="input.tutor">
