<template>
  <div v-if="datos && $store.state.sesion && $store.state.tipo == 'Profesor'" :data="datos" class="col">
    <!-- modal addyear -->
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" v-on:click="cambio(), clear()">
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="form-group">
                <label for="HoraEntrada" class="col-form-label">Hora Entrada:</label>
                <input type="time" v-model="input.HE" class="form-control" id="HoraEntrada" />
              </div>
              <div class="form-group">
                <label for="HoraSalida" class="col-form-label">Hora Salida:</label>
                <input type="time" v-model="input.HS" class="form-control" id="HoraSalida" />
              </div>
              <div class="form-group">
                <label for="FechaInicio" class="col-form-label">Fecha Inicio:</label>
                <input type="date" v-model="input.FI" class="form-control" id="FechaInicio" />
              </div>
              <div class="form-group">
                <label for="FechaFin" class="col-form-label">Fecha Fin:</label>
                <input type="date" v-model="input.FF" class="form-control" id="FechaFin" />
              </div>
            </form>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-dismiss="modal" v-on:click="cambio(), clear()">
              Cancelar
            </button>
            <button type="button" class="btn btn-primary" v-on:click="addyear()">
              Añadir Año al grado
            </button>
          </div>
        </div>
    ...
    <!--modal add grado-->
    <div class="modal fade" id="AddGrado" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                ...
                <input type="text" v-model="input.Grado" class="form-control" id="Nombre" />
              </div>
              <div class="form-group">
                <label for="HoraEntrada" class="col-form-label">Hora Entrada:</label>
                <input type="time" v-model="input.HE" class="form-control" id="HoraEntrada" />
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" v-on:click="addgrado()">
              Guardar Grado
            </button>
          </div>
        </div>
      ...
      <div class="col-6 col-md-6" v-for="datos in datos" :key="datos">
        <div class="card bg-primary">
          <div class="card-body row">
            ...
            <button v-if="datos.anios.length < 2" class="col btn" data-toggle="modal" data-target="#addyear"
          ...
          <ul class="list-group list-group-flush">
            <router-link :to="'/Cursos/' + anios" v-for="anios in datos.anios" :key="anios._id">
