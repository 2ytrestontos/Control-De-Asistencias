<template>
  <div v-if="$store.state.sesion && $store.state.tipo == 'Profesor'" v-on:keyup.enter="registro()">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="form-group">
                ...
                <input type="text" v-model="input.usuario" class="form-control" id="nombre"
                  placeholder="Nombre del profesor" />
              </div>

              <div class="form-group">
                <!-- <label for="pass" class="col-form-label">Contraseña</label> -->
                <input type="password" v-model="input.pass" class="form-control" id="pass" placeholder="Contraseña" />
              </div>
              <div class="form-group">
                <!-- <label for="pass" class="col-form-label">Contraseña</label> -->
          ...
          <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" v-on:click="registro()">
              Agregar Profesor
            </button>
          </div>
        </div>
    ...
    <div class="izq">
      ...
      <ul class="list-group" scroll="no">
        <li class="list-group-item m-0" v-for="datos in datos" :key="datos._id" v-on:click="redirect(datos._id)">
          {{ datos.Nombre }}
        </li>
      </ul>
